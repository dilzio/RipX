 ...
 */
package org.dilzio.riphttp.disruptor.ext;

import com.lmax.disruptor.*; //NOPMD
 ...
 *
 * Original version taken from LMAX library com.lmax.disruptor.WorkerPool
 * 
...
public final class WorkerPool<T>
{
                      ...
                      final WorkHandler<T>... workHandlers)
    {
        ...
        {
            workProcessors[i] = new WorkProcessor<T>(ringBuffer,      //NOPMD
                                                     sequenceBarrier,
                                                     workHandlers[i],
                                                     exceptionHandler,
                                                     workSequence);
